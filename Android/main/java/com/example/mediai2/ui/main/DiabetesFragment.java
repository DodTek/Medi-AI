 ...
 * {@link DiabetesFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link DiabetesFragment#newInstance} factory method to
...
public class DiabetesFragment extends Fragment {
    ...
    public static DiabetesFragment newInstance(int index) {
        DiabetesFragment fragment = new DiabetesFragment();
        Bundle bundle = new Bundle();
        bundle.putInt(null,index);
